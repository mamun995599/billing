...
function setupRcloneConfig() {
    ...
    // Try to find the user's rclone config
    $userProfile = getenv('USERPROFILE');
    if ($userProfile === false) {
        logMessage("❌ Could not get user profile path");
        return false;
    }
    
    $userConfigPath = "$userProfile/AppData/Roaming/rclone/rclone.conf";
...
// Function to convert Windows path to forward slashes for rclone
